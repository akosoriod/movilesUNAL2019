...
*/
       ...
       // mSoundButton = (Button) findViewById(R.id.sound_b);
        ...
        mBoardView = (Board) findViewById(R.id.board);
        ...
        if (!humanstart) {
            ...
            handler.postDelayed(new Runnable() {
                public void run() {
                    ...
                    if(sound){mComputerMediaPlayer.start();}
...
// Determine which cell was touched
            ...
            if (humanturn) {
                if (!gameover && setMove(TicTacToeGame.HUMAN_PLAYER, pos)) {
                    ...
                    // If no winner yet, let the computer make a move
                    if(sound){mHumanMediaPlayer.start();}
                        ...
                        handler.postDelayed(new Runnable() {
                            public void run() {
                                ...
                                if (winner == 0) {
                                    ...
                                    if(sound){mTieMediaPlayer.start();}
                                    updateTextViews(1, R.string.result_tie, Color.rgb(0, 0, 200));
                                } else if (winner == 2) {
                                    if(sound){mWinMediaPlayer.start();}
                                    ...
                                    if(sound){mLoseMediaPlayer.start();}
